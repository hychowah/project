...
| Domain | Technologies |
|--------|-------------|
| **Languages** | Python, C++, Embedded C++ (Teensy, ESP32), QML, Bash |
| **Robotics** | ROS2, PID control, constrained optimization (NLopt), Kalman filtering, SLAM (FAST-LIO2), LiDAR odometry, OpenCV |
| **UI / HMI** | PySide6, Qt/QML, custom operator interfaces on Linux handhelds |
| **Embedded** | PCB design, Teensy, ESP32-C3, serial protocols, UDP, sensor fusion |
| **Infrastructure** | GStreamer, NTP sync, systemd, udev, network monitoring |
| **Mechanical** | DFMA, SolidWorks, static FEA, topology optimization, GD&T |
| **AI / LLM** | LLM-first architecture design, prompt engineering, adaptive systems |
...
**US 12,398,527 B2** — Cable-suspended robotic platform for deep-foundation inspection (co-inventor)
[View on Google Patents →](https://patents.google.com/patent/US12398527B2/en)
